...
public class searchBloodDonorBloodGroup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 70, -1, 20));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 70, 134, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 125, 700, 259));
        ...
        jButton3.setFont(new java.awt.Font("Bitstream Charter", 1, 18)); // NOI18N
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try
        {
         ...
         ResultSet rs=st.executeQuery("select * from donor where bg like '%"+bg+"%'");
